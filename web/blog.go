...
func blogFromForm(id int64, rr requestSession) models.Blog {
...
func blogView(rr requestSession) {
...
func blogViewOne(rr requestSession, id int64) {
...
func blogViewAll(rr requestSession) {
...
func blogAction(rr requestSession) {
...
func blogSave(rr requestSession, id int64) {
...
func blogNew(rr requestSession) {
...
func blogDraft(rr requestSession, id int64) {
	// AJAX request
}

func blogPost(rr requestSession, id int64) {
	// AJAX request
}

func blogEdit(rr requestSession, id int64) {
	log.Printf("Loading %d", id)
